...
public class Monster1 : MonoBehaviour
{
    ...
    [Header("Monster1 Health")]
    [SerializeField] private Monster1Health monster1Health;
    ...
    private void Awake()
    {
        ...
        monster1Health = GetComponentInChildren<Monster1Health>();
    }
    ...
    public void monsterHitDamage(float takeDamage)
    {
        ...
        monster1Health.ReducedHealthSlider(takeDamage);

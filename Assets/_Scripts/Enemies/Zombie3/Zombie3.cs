...
public class Zombie3 : MonoBehaviour
{
    ...
    private Zombie3RaycastWeapon zombie3RaycastWeapon;

    [Header("Zombie3 Health")]
    [SerializeField] private Zombie3Health zombie3Health;

    [Header("Enemy Spawn")]
    public EnemySpawn enemySpawn;

    // Do Zombie3 là prefabs nên không thể kéo các GameObject chứa script của GameObject đó nên cần phải dùng event để thực thi
    ...
    private void Awake()
    {
        ...
        zombie3RaycastWeapon = GetComponentInChildren<Zombie3RaycastWeapon>();

        zombie3Health = GetComponentInChildren<Zombie3Health>();
    }
    ...
    private void MoveToRandomPosition()
    {
        ...
        if (NavMesh.SamplePosition(randomPosition, out hit, 500f, NavMesh.AllAreas))
        {
            ...
            zombie3RaycastWeapon.StopFiring();
        }
    }
    ...
    private void AttackPlayer()
    {
        ...
        if (!previouslyAttack)
        {
            ...
            if (Physics.Raycast(AttackingRaycastArea.transform.position, AttackingRaycastArea.transform.forward, out hitInfo, attackingRadius))
            {
                ...
                zombie3RaycastWeapon.StartFiring();
            }
    ...
    public void zombieHitDamage(float takeDamage)
    {
        ...
        zombie3Health.ReducedHealthSlider(takeDamage);

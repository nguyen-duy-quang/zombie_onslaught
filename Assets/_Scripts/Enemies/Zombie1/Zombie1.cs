...
public class Zombie1 : MonoBehaviour
{
    ...
    [Header("Zombie1 Health")]
    [SerializeField] private Zombie1Health zombie1Health;
    ...
    private void Awake()
    {
        ...
        zombie1Health = GetComponentInChildren<Zombie1Health>();
    }
    ...
    public void zombieHitDamage(float takeDamage)
    {
        ...
        zombie1Health.ReducedHealthSlider(takeDamage);
